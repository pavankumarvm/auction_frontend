  ...
  render() {
    return (
      <div className="product">
        <div
          class="intro-section"
          // style="background-image:url(images/xproduct_1.jpg.pagespeed.ic.jv58llKnOW.webp)"
        >
          <div class="container">
            ...
            <div class="row">
              <div class="col-lg-3 order-lg-2">
                <div class="side-box mb-4">
                  <p>
                    Price: <strong class="text-black">$95</strong> <br />
                    Number of Bids: <strong class="text-black">4</strong>
                  </p>
                  <form action="#">
                    <div class="mb-4">
                      <input
                ...
                <div class="side-box text-center">
                  ...
                  <p>
                    ...
                    Nihil repudiandae recusandae, incidunt possimus provident
                    vel facilis!
                  </p>
                </div>
              </div>
              <div class="col-lg-8 pr-lg-5">
                ...
                <p>
                  Ducimus, pariatur, culpa nihil molestias ea repellendus
                  adipisci harum ipsam perferendis, quisquam nulla ipsa fugit!
                  Minima velit explicabo eos, perspiciatis facilis illo,
                  architecto earum sed dolores maiores vitae soluta repellat.
                </p>
                <p>
                  Suscipit dolor consequuntur cum illo eos, perspiciatis
                  voluptas ut, officia quos minus. Adipisci in consequatur,
                  suscipit ipsum, doloribus dolorem vel quod blanditiis fugiat
                  recusandae. Illum tenetur impedit eligendi cum qui.
                </p>
